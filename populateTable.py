...
for obj in categorias:
    # Extrair os valores do objeto
    id_categoria_value = obj.id_categoria
    nome_categoria_value = obj.nome_categoria
    id_categoria_value = obj.id_categoria
    asin_original = obj.asin
    num_categoria_value = obj.num_categoria
    ...
    cur.execute("INSERT INTO Categories (ID, ASIN_original, Num_Categoria, ID_Categoria) VALUES (?, ?, ?, ?)", 
            (id, asin_original, num_categoria_value, id_categoria_value))
    id+=1
